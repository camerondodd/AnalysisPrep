			...
			<div>
				...
				<div  className="InfoContainer">
					...
					<div className="Question" onClick={()=>this.handleClickQ2()}>
						<h2>Why use Analysis Prep?</h2>
					</div>
					<ToggleDisplay show={this.state.q2}>
					<div className="Answer">
						<p>Analysis Prep is the toolbox any analyst needs to get started.</p>
						<p>Analysis Finder includes over 30 different analyses all in one place, which makes it the most comprehensive guide to date.  It also walks you through the difficult process of selecting the appropriate test for your data, which can be a struggle for students and veterans alike.</p>
						...
						<p>Analysis Prep can save up to a day's worth of work with all of the tools needed to get the user ready to run their analysis.</p>
					</div>
					</ToggleDisplay>

					<div className="Question" onClick={()=>this.handleClickQ3()}>
						<h2>Who should use Analysis Prep?</h2>
					</div>
					<ToggleDisplay show={this.state.q3}>
					<div className="Answer">
						<p>Analysis Prep is largely aimed at analysts, researchers, and graduate students, but anyone with some background in statistics or is trying to learn statistics will benefit.</p>
					</div>
					</ToggleDisplay>
